...
public QuanLyMuonController(JPanel pnView, JTextField txtSearch, JTextField txtMaThe, JTextField txtMaThuThu,
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==btAdd) {
			m = new Muon(txtMaThe.getText(), txtMaThuThu.getText(), txtMaSach.getText(), covertDateToDateSql((Date) txtNgayMuon.getDate()), Integer.parseInt(txtSoSachMuon.getText()));
		muonservice.Insert(m);
		setDateToTable();
		
		}else if(e.getSource()==btDelete) {
			String sql = "Delete from Muon where MaThe=\'" + txtMaThe.getText() + "\' and NgayMuon=\'"+txtNgayMuon.getDate()+"\'";
			try {
