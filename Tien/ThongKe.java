...
private javax.swing.JPanel pnView;
	public ThongKe() {
        ...
        cb.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sách", "Mượn ", "Trả" }));

        javax.swing.GroupLayout gl_pnQuery = new javax.swing.GroupLayout(pnQuery);
        gl_pnQuery.setHorizontalGroup(
        	gl_pnQuery.createParallelGroup(Alignment.TRAILING)
        		.addGroup(gl_pnQuery.createSequentialGroup()
        			.addGap(18)
        			.addComponent(lbFind, GroupLayout.DEFAULT_SIZE, 134, Short.MAX_VALUE)
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addComponent(cb, 0, 171, Short.MAX_VALUE)
        			.addGap(18)
        			.addComponent(btFind, GroupLayout.DEFAULT_SIZE, 75, Short.MAX_VALUE)
        			.addGap(30))
        );
        ...
        gl_pnView.setHorizontalGroup(
            gl_pnView.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
