				...
				.addGroup(gl_pnQuery.createSequentialGroup()
					...
					.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_pnQuery.createSequentialGroup()
							...
							.addGap(24)
							.addComponent(txtFind, GroupLayout.DEFAULT_SIZE, 172, Short.MAX_VALUE)
							.addGap(217))
						.addGroup(gl_pnQuery.createSequentialGroup()
							.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_pnQuery.createSequentialGroup()
									.addGap(58)
									.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING)
										.addComponent(lbMaDocGia, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
										.addComponent(lbHoDem, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
										.addComponent(lbTen, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
										.addComponent(lbNgaySinh, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE))
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING)
										.addComponent(txtMaDocGia, GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
										.addGroup(gl_pnQuery.createSequentialGroup()
											.addComponent(txtHoDem, GroupLayout.DEFAULT_SIZE, 148, Short.MAX_VALUE)
											.addGap(2))
										.addGroup(Alignment.TRAILING, gl_pnQuery.createSequentialGroup()
											.addGroup(gl_pnQuery.createParallelGroup(Alignment.TRAILING)
												.addComponent(txtNgaySinh, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 148, Short.MAX_VALUE)
												.addComponent(txtTen, GroupLayout.DEFAULT_SIZE, 148, Short.MAX_VALUE))
											.addGap(2)))
									.addGap(26)
									.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING)
										.addComponent(lbGioiTinh, GroupLayout.DEFAULT_SIZE, 141, Short.MAX_VALUE)
										.addComponent(lbSDT, GroupLayout.DEFAULT_SIZE, 141, Short.MAX_VALUE)
										.addComponent(lbDiaChi, GroupLayout.DEFAULT_SIZE, 141, Short.MAX_VALUE)
										.addComponent(lbMaLoaiDocGia, GroupLayout.DEFAULT_SIZE, 141, Short.MAX_VALUE)))
								.addGroup(gl_pnQuery.createSequentialGroup()
									.addGap(113)
									.addComponent(btAdd, GroupLayout.DEFAULT_SIZE, 67, Short.MAX_VALUE)
									.addGap(123)
									.addComponent(btInsert, GroupLayout.DEFAULT_SIZE, 79, Short.MAX_VALUE)
									.addGap(125)))
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_pnQuery.createSequentialGroup()
