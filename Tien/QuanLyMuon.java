				...
				.addGroup(gl_pnQuery.createSequentialGroup()
					...
					.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_pnQuery.createSequentialGroup()
							.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_pnQuery.createSequentialGroup()
									...
									.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING)
										...
										.addComponent(lbSoSachMuon, GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE)
										.addComponent(lbNgayMuon, GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE))
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING)
										.addComponent(txtNgayMuon, GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)
										.addComponent(txtMaThe, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)
										.addComponent(txtSoSachMuon, GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE))
									.addGap(26)
									.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING)
										.addComponent(lbMaThuThu, GroupLayout.DEFAULT_SIZE, 144, Short.MAX_VALUE)
										.addComponent(lbMaSach, GroupLayout.DEFAULT_SIZE, 144, Short.MAX_VALUE)))
								.addGroup(gl_pnQuery.createSequentialGroup()
									.addGap(113)
							...
							.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_pnQuery.createSequentialGroup()
									.addComponent(btDelete, GroupLayout.DEFAULT_SIZE, 83, Short.MAX_VALUE)
									.addGap(77))
								.addComponent(txtMaThuThu, GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
								.addComponent(txtMaSach, GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE))))
					.addGap(29))
		);
