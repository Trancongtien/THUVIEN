...
public class QuanLySach extends JPanel {
	...
	public QuanLySach() {
		...
		gl_pnQuery.setHorizontalGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnQuery
						...
						.addGroup(gl_pnQuery.createParallelGroup(Alignment.TRAILING)
								.addGroup(gl_pnQuery.createSequentialGroup().addGap(121)
										.addComponent(btFind, GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE).addGap(65)
										.addComponent(
												txtFind, GroupLayout.DEFAULT_SIZE, 167, Short.MAX_VALUE)
										.addGap(71).addComponent(cb, 0, 125, Short.MAX_VALUE))
								.addGroup(gl_pnQuery.createSequentialGroup()
										.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING, false)
												...
												.addComponent(lbTenSach, GroupLayout.DEFAULT_SIZE,
														GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(lbTomTat, GroupLayout.DEFAULT_SIZE,
														GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(lbSoTrang, GroupLayout.DEFAULT_SIZE,
														GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(lbDonGia, GroupLayout.DEFAULT_SIZE,
														GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
										...
										.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING)
												...
												.addComponent(txtTenSach).addComponent(txtTomTat)
												.addComponent(txtSoTrang).addComponent(txtDonGia))
										.addGap(30)
										.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING, false)
												.addComponent(lbNamXB, GroupLayout.DEFAULT_SIZE,
														GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(lbTrangThai, GroupLayout.DEFAULT_SIZE,
														GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(lbTacGia, GroupLayout.DEFAULT_SIZE,
														GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(lbMaTheLoai, GroupLayout.DEFAULT_SIZE,
														GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(lbMaNXB, GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE))
										.addPreferredGap(ComponentPlacement.UNRELATED)
										.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING)
												.addComponent(txtNamXB).addComponent(txtTrangThai)
												.addComponent(txtTacGia, GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)
												.addComponent(txtMaTheLoai).addComponent(txtMaNXB))))
						.addGap(27)
						.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING)
								.addComponent(btAdd, Alignment.TRAILING).addComponent(brInsert, Alignment.TRAILING)
		...
		gl_pnQuery.setVerticalGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnQuery.createSequentialGroup().addContainerGap()
						.addGroup(gl_pnQuery
								.createParallelGroup(Alignment.BASELINE).addComponent(btFind)
								.addComponent(txtFind, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(
										cb, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_pnQuery.createParallelGroup(Alignment.LEADING).addGroup(gl_pnQuery
								.createSequentialGroup().addGap(18)
								.addGroup(gl_pnQuery.createParallelGroup(Alignment.BASELINE, false)
										.addComponent(lbMaSach)
										.addComponent(txtMaSach, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(lbNamXB).addComponent(
												txtNamXB, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE))
								.addGap(18)
								.addGroup(gl_pnQuery.createParallelGroup(Alignment.BASELINE)
										.addGroup(gl_pnQuery.createSequentialGroup().addGap(6).addComponent(lbTenSach,
												GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
										.addComponent(txtTenSach, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(lbTrangThai).addComponent(txtTrangThai)))
								.addGroup(gl_pnQuery.createSequentialGroup().addGap(35).addComponent(btAdd)))
						.addGap(18)
						.addGroup(gl_pnQuery.createParallelGroup(Alignment.BASELINE).addComponent(lbTomTat)
								.addComponent(txtTomTat, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lbTacGia)
								.addGroup(gl_pnQuery.createSequentialGroup().addGap(2).addComponent(txtTacGia))
								.addComponent(brInsert))
						.addGap(18)
						.addGroup(gl_pnQuery.createParallelGroup(Alignment.BASELINE).addComponent(lbSoTrang)
								.addComponent(txtSoTrang, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lbMaTheLoai).addComponent(txtMaTheLoai, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGap(18)
						.addGroup(gl_pnQuery.createParallelGroup(Alignment.BASELINE).addComponent(lbDonGia)
								.addComponent(txtDonGia, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE)
								.addComponent(lbMaNXB)
								.addGroup(gl_pnQuery.createSequentialGroup().addGap(2).addComponent(txtMaNXB))
	...
	QuanLySachController controller= new QuanLySachController(pnTable, btFind, txtFind);
