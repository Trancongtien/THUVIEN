...
public class QuanLyMuon extends JPanel {
	...
	public QuanLyMuon() {
        			...
        			.addGroup(gl_pnView.createParallelGroup(Alignment.LEADING)
        				...
        				.addGroup(gl_pnView.createSequentialGroup()
        					...
        					.addGroup(gl_pnView.createParallelGroup(Alignment.LEADING)
        						...
        						.addComponent(txtNgayMuon, GroupLayout.DEFAULT_SIZE, 132, Short.MAX_VALUE))
        					.addPreferredGap(ComponentPlacement.UNRELATED)
        					.addGroup(gl_pnView.createParallelGroup(Alignment.LEADING)
        ...
        QuanLyMuonController controller = new QuanLyMuonController(pnTable, txtFind, txtMaThe, txtMaThuThu, txtMaSach, btAdd, btDelete, btInsert, txtNgayMuon);
